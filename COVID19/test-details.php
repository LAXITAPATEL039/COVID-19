...
if (strlen($_SESSION['aid'] == 0)) {
  ...
  if (isset($_POST['takeaction'])) {
    ...
    if ($status == 'Delivered') :
      ...
      //VALIDATION FOR ALLOWED EXTENTION .in_array() FUNCTION SEARCHES AN ARRAY FOR A SPECIFIC VALUE.
        ...
        <div id="content">
          ...
          <div class="container-fluid">
            ...
            <div class="row">
              ...
              <?php
              $testid = intval($_GET['tid']);
              $query = mysqli_query($con, "select * from tbltestrecord join tblpatients on tblpatients.MobileNumber=tbltestrecord.PatientMobileNumber where tbltestrecord.id='$testid'");
          ...
          <?php
          $orderid = intval($_GET['oid']);
          $ret = mysqli_query($con, "select * from tblreporttracking join tbladmin on tbladmin.ID=tblreporttracking.RemarkBy where tblreporttracking.OrderNumber='$orderid'");
