            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <!--PAGE HEADING-->
                        <h1 class="h3 mb-2 text-gray-800">Ontheway for sample collection</h1>

                        <!--DATATABLES EXAMPLE-->
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">Ontheway for sample collection</h6>
                            </div>
                            <div class="card-body">
